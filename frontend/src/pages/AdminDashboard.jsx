              ...
              <Table>
                ...
                <TableBody>
                  {[
                    ...
                    { inv: "INV003", status: "Paid", method: "Bank Transfer", amount: "$350.00" },
                    { inv: "INV004", status: "Paid", method: "Credit Card", amount: "$450.00" },
                    { inv: "INV005", status: "Paid", method: "PayPal", amount: "$550.00" },
                  ].map((item, i) => (
                    <TableRow key={i}>
                      <TableCell className="font-medium">{item.inv}</TableCell>
                      <TableCell><Badge variant={item.status === "Paid" ? "outline" : "secondary"}>{item.status}</Badge></TableCell>
                  ...
                  {[1, 2, 3, 4, 5].map((_, i) => (
                    <div className="flex items-center" key={i}>
                      ...
                      <div className="ml-4 space-y-1">
                        <p className="text-sm font-medium leading-none">User Name {i+1}</p>
